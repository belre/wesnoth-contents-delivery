...
| ファイル | 中身 | 収録数 |
|---|---|---|
| units-loyalists.psp | 人間族(忠誠軍)ユニットの全アニメフレーム | 275 |
| units-northerners.psp | オーク(北方勢)同上 | 179 |
| units-undead.psp / units-rebels.psp / units-drakes.psp / units-knalgan.psp | その他陣営(mini-wesgameでは非プレイアブルだが、アプリのpublic/から静的配信されうるため同梱) | 224 / 147 / 203 / 13 |
